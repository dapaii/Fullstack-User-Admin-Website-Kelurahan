...
class PdfGeneratorIn extends BaseController
{
    public function generatePDF()
    {
        $model = new \App\Models\InventarisasiModel(); // Sesuaikan dengan namespace dan nama model Anda

        $data['inventarisasi'] = $model->findAll(); // Ambil data decision dari model
