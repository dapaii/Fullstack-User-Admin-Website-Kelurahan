...
<head>
    <title>Tambah Agenda Keluar</title>
...
<body>
    ...
    <section class="container">
        <h1 class="mt-5 mb-4 text-center">Tambah Agenda Keluar</h1>

        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="/agendak/create" method="post" class="card p-4 shadow rounded" style="background-color: #f9f9f9;">
                    <?= csrf_field(); ?>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    <label for="t_pengiriman" class="form-label">Tanggal Pengirim</label>
                    <input type="date" id="t_pengiriman" name="t_pengiriman" class="form-control">
                </div>
                <div class="mb-3">
                    <label for="keterangan" class="form-label">Keterangan</label>
                    <textarea id="keterangan" name="keterangan" class="form-control" rows="4"></textarea>
                </div>
                <input type="submit" value="Tambah Agenda Keluar" class="btn btn-primary">
                </form>
            </div>
        </div>
    </section>
