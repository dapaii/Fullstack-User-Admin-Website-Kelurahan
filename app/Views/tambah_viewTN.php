...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="<?= base_url(); ?>tambahTN" class="nav-link px-2 link-secondary">CreateTanah</a></li>
    ...
    <section class="container">
        <h1 class="mt-5 mb-4 text-center">Tambah Tanah</h1>

        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="/tanah/create" method="post" class="card p-4 shadow rounded" style="background-color: #f9f9f9;">
                    <?= csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="perorangan" name="perorangan" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="badan_hukum" class="form-label">Badan Hukum</label>
                                        <input type="text" id="badan_hukum" name="badan_hukum" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        <label for="hm" class="form-label">Hak Milik</label>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="hgb" name="hgb" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="hgu" name="hgu" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        <label for="hpl" class="form-label">Hak Pengelolaan</label>
                                        <input type="text" id="hpl" name="hpl" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="vp" name="vp" class="form-control">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
            ...
            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" type="text" id="sudah" name="sudah" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="belum" class="form-label">Belum</label>
                                    <input type="text" id="belum" name="belum" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="perumahan" name="perumahan" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="perdagangan" class="form-label">Perdagangan</label>
                                    <input type="text" id="perdagangan" name="perdagangan" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="perkantoran" class="form-label">Perkantoran</label>
                                    <input type="text" id="perkantoran" name="perkantoran" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="fasilitas_umum" name="fasilitas_umum" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="lain_lain" class="form-label">Lain - Lain</label>
                                    <input type="text" id="lain_lain" name="lain_lain" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <input type="submit" value="Tambah Tanah" class="btn btn-primary">
                </form>
            </div>
        </div>
    </section>
